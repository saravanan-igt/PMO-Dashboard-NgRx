...
@Component({
  selector: 'app-lottery-svc',
  templateUrl: './lottery-svc.component.html',
  styleUrls: ['./lottery-svc.component.scss']
})
export class LotterySvcComponent implements OnInit {

  pageTitle: string = "Lottery Services – Customer Support";
    ...
    this.DataSubscription = this.dataList$
      ...
      .subscribe((data) => {
        if (data.Data.length) {
          ...
          this.customerData = this.DataLists[0].customer.svc;
