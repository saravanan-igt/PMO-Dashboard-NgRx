...
@Component({
  selector: "app-vlt-rnd",
  templateUrl: "./vlt-rnd.component.html",
  styleUrls: ["./vlt-rnd.component.scss"],
})
export class VltRndComponent implements OnInit {
  pageTitle: string = "VLT R & D";
